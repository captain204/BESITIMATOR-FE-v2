...
const FAQSection = () => {
    ...
    },
    {
      ...
      answer: (
        <div className="flex flex-col justify-center items-center">
          <p className="mb-4 text-black">please see below:</p>
          <img
            src="/faq.png"
            alt="Our Services"
...

    {
      ...
      answer: (
        <div className="">
          ...
          <h6 className="text-black text-start mt-4 font-bold">
            Calculation: 4.66m + 2.71m + 3.41m + 1.80m + 1.25m + 0.91m = 14.74m
          </h6>

          <p className=" text-black f">
...

    {
      ...
      answer: (
        <div>
          ...
          <h6 className="text-black text-sm font-bold mt-3">
  ...
  return (
    ...
    <div className="space-y-4">
      {faqs.map((faq, index) => (
        <div key={index} className="border-b border-gray-300 pb-4 bg-gray-50">
          <button
            className="w-full flex justify-between items-center p-4 rounded-lg text-left focus:outline-none focus:ring-2 focus:ring-gray-300"
          ...
          {activeIndex === index && (
            <div className="mt-4 text-gray-800 mx-4">
              {faq.answer}
            </div>
          )}
        </div>
