...
const Card = ({ card }: any) => {
  ...
  const shortDescription = card.description.slice(0, descriptionLimit);

  const shouldShowButton = card.description.length > descriptionLimit;

  return (
    <div className="max-w-sm bg-white border rounded-lg shadow-lg dark:bg-gray-800 p-4 md:p-6 hover:shadow-2xl transition-all duration-300 z-10">
      ...
      <div className="flex justify-between items-center mt-3">
        {shouldShowButton && (
          <button
            ...
            className="text-[#000033] font-semibold hover:underline  "
          >
        ...
        <a
          href="#"
          className="inline-flex items-center font-extrabold text-yellow-700 hover:underline"
        >
          {card.link}
