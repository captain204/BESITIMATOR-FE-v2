                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-transparent border border-gray-400 rounded-xl text-black text-sm  block w-full p-2.5"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="border bg-transparent border-gray-400 rounded-lg text-sm  block w-full p-2.5 text-black"
                      // value={role}
                      // onChange={(e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-transparent border border-gray-400 text-gray-400 rounded-xl text-sm  block w-full p-2.5"
