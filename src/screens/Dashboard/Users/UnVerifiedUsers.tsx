...
const UnverifiedUsers = () => {
  ...
  const handleExport = (format: "pdf" | "xlsx") => {
    if (format === "xlsx") {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "UnverifiedUsers");
      XLSX.writeFile(workbook, "UnverifiedUsers.xlsx");
    } else if (format === "pdf") {
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axiosInstance.get("/api/admin/unverified");
