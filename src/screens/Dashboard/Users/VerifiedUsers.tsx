...
const VerifiedUsers = () => {
  ...
  const handleExport = (format: "pdf" | "xlsx") => {
    if (format === "xlsx") {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "VerifiedUsers");
      XLSX.writeFile(workbook, "VerifiedUsers.xlsx");
    } else if (format === "pdf") {
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axiosInstance.get("/api/admin/verified-users");
