...
export default function Subscribers() {
  ...
  const fetchSubscribers = async () => {
    ...
    try {
      const response = await axiosInstance.get("/admin/subscribe/total");
  ...
  const filteredQuestions = subscribers.filter((subscribers) => {
    const text = subscribers.text?.toLowerCase() || "";
