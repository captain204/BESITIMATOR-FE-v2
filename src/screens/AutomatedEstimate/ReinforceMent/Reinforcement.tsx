...
//   useEffect(() => {
//     localStorage.setItem("Where-you-need-your-reinforcement-for", selectedOption);
//   }, [selectedOption]);

//   useEffect(() => {
//     const storedOption = localStorage.getItem("Where-you-need-your-reinforcement-for");
//     const validOption = options.find(opt => opt.value === storedOption)?.value || "Ground beams";
...
//   const selectedComponent = options.find((opt) => opt.value === selectedOption)?.component;
