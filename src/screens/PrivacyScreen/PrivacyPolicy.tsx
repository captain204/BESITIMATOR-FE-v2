    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto p-6 bg-white  text-black rounded-lg shadow-lg border overflow-hidden">
        ...
        <p className="mb-4">
          ...
          and Premium app. This SERVICE is provided by Building Estimator at no
          cost for its freemium service and at a charged cost for its premium
          service and is intended for use as is.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          Terms and Conditions, which is accessible at The Building Estimator
        ...
        <p className="mb-4">
          ...
          including but not limited to Email address, Name, Phone number,
          Location. The information that we request will be retained by us and
